...
void MainWindow::on_action_Zoom_in_triggered()
{
    ...
    try
    {
        size.zoom_in(imageLabel->width(), imageLabel->height());
    }
    catch (int)
    {
        QMessageBox::warning(this, "Error", "Width or height is below zero.");
        return;
    }
...
void MainWindow::on_action_Zoom_out_triggered()
{
    ...
    try
    {
        size.zoom_out(imageLabel->width(), imageLabel->height());
    }
    catch (int)
    {
        QMessageBox::warning(this, "Error", "Width or height is below zero.");
